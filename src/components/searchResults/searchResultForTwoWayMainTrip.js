...
const SearchResultForTwoWayMainTrip = ({ searchResult }) => {
      ...
      <div className="mb-2 bg-[#696868]">
        ...
        <Formik
          ...
          onSubmit={values => {
            dispatch(
              setTravelDetail({
                returnTravel: travelDetail.returnTravel,
                mainTravel: {
            ...
            navigate('/bookingResultsTwoWayTripReturn');
          }}
        >
...
export default SearchResultForTwoWayMainTrip;
